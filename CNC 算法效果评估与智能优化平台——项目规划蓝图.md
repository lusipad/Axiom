...
> 文档类型：产品总纲与 Roadmap  
> 状态：Draft / 方向重整与契约闭合版 v0.6
> 当前阶段：R0/R1 已闭合 + R2 Math F2
> 更新日期：2026-08-12
...
- R2：保持五轴数学规范完整；Math F2 运动学参考栈已经通过同一 Core 运行路径落地，覆盖三类 canonical 机床、M2→M3 连续提升和 `Q_free` 区间碰撞证据；下一工作面是 F3 时间与离散参考栈。
